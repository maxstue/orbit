...
const orbitalWorlds: Record<
  Exclude<WorldId, 'home'>,
  {
    className: string
    duration: number
    startAngle: number
...
> = {
  current: { className: 'world-now orbit-1', duration: 54, startAngle: 160 },
  workbench: { className: 'world-work orbit-2', duration: 88, startAngle: 275 },
  'side-quests': { className: 'world-quests orbit-3', duration: 126, startAngle: 8 },
  comms: { className: 'world-comms orbit-2', duration: 88, startAngle: 95 },
}
    ...
    <LazyMotion features={loadMotionFeatures} strict>
      <main className="system booted relative min-h-svh overflow-hidden bg-[radial-gradient(circle_at_52%_47%,#1b2525_0,#101617_26%,var(--space)_68%)] text-[var(--paper)]">
        ...
        <motionElement.header
          ...
          transition={{ duration: reduceMotion ? 0 : 0.58, delay: reduceMotion ? 0 : 0.62 }}
        >
          <LocalizedLink
            locale={locale}
        ...
        >
          <motionElement.div
            ...
            transition={{ duration: reduceMotion ? 0 : 0.62, delay: reduceMotion ? 0 : 0.7 }}
          >
          ...
          <motionElement.div
            ...
            transition={{ duration: reduceMotion ? 0 : 0.58, delay: reduceMotion ? 0 : 0.8 }}
          >
            <Button
          ...
          {worlds.slice(1).map((world, index) => {
            ...
            const orbit = orbitalWorlds[world.id as Exclude<WorldId, 'home'>]
            const orbitRotation = reduceMotion
              ? orbit.startAngle
              : [orbit.startAngle, orbit.startAngle + 360]
            const planetRotation = reduceMotion
              ? -orbit.startAngle
              : [-orbit.startAngle, -orbit.startAngle - 360]
              ...
              >
                ...
                >
                  <div className="pointer-events-auto absolute top-1/2 left-full -translate-1/2">
                    ...
                    >
                      <Button
                        className={`world group relative z-3 h-auto rounded-none border-0 bg-transparent p-0 text-left hover:bg-transparent [@media(pointer:coarse)]:min-h-11 [@media(pointer:coarse)]:min-w-11 ${orbit.className.split(' ')[0]}${selectedSignal === world.id ? ' signal-selected' : ''}`}
                      ...
                      >
                        ...
                        <motionElement.span
                          ...
                          transition={{
                            ...
                            delay: reduceMotion ? 0 : 0.76 + index * 0.055,
                          }}
                        >
          ...
          <motionElement.div
            ...
            transition={{ duration: reduceMotion ? 0 : 0.52, delay: reduceMotion ? 0 : 0.96 }}
          >
            <span>
        ...
        <motionElement.footer
          ...
          initial={reduceMotion ? false : { opacity: 0, y: 6 }}
          animate={{ opacity: 1, y: 0 }}
          transition={{ duration: reduceMotion ? 0 : 0.52, delay: reduceMotion ? 0 : 1.02 }}
        >
